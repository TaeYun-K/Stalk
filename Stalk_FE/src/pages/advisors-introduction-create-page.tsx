...
const AdvisorsIntroductionCreatePage: React.FC = () => {
        ...
        <div className="flex gap-8 relative">
          ...
          <div className="flex-1 space-y-12">
            ...
            <section className="space-y-8">
              ...
              {/* 초기 상담 영업 시간 설정 */}
              <div>
                <h3 className="py-3 text-left text-lg font-semibold text-black">초기 상담 영업 시간 설정</h3>  
...
export default AdvisorsIntroductionCreatePage;