...
const AdvisorsDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchExpertDetails = async () => {
      ...
      try {
        ...
        // 토큰이 있으면 인증 요청, 없으면 공개 요청으로 시도
        const token = AuthService.getAccessToken();
        const endpoint = `/api/advisors/${id}`;
        const response = token
          ? await AuthService.authenticatedRequest(endpoint)
...
export default AdvisorsDetailPage;
