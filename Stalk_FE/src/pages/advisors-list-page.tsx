...
const AdvisorsListPage = () => {
  ...
  const handleExpertClick = (expertId: number) => {
    navigate(`/advisors-detail/${expertId}`);
  };
  ...
  return (
    ...
    <div className="min-h-screen bg-white relative">
      ...
      {userInfo?.role === "ADVISOR" && (
        <button
          onClick={() => navigate(`/advisors-introduction-create/${userInfo.userId}`)}
              ...
              >
                ...
                <div className="px-12 flex h-50 items-start items-end justify-between">
                  <div className="flex-1 py-10">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      <p className="px-4 py-2 rounded-2xl text-xs font-medium bg-blue-100 text-blue-700">
                        상담료(시간당) {formatConsultationFee(expert.consultationFee)}
                      </p>
                    </div>
                  </div>
