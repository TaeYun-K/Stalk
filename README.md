...
**Stalk**는 투자 전문가와 사용자가 실시간으로 차트를 보며 소통하는 WebRTC 기반의 화상 상담 서비스입니다. 기존의 온라인 강의나 증권사 리포트와 같은 일방향적인 정보 제공 방식의 한계를 극복하고, 개인 맞춤형 투자 상담을 제공하여 투자 지식을 더 똑똑하게 공유하고 성장하는 것을 목표로 합니다
